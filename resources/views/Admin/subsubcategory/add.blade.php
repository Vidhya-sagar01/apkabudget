...
@section('content')
    ...
    <div class="card shadow-sm border-0 rounded-lg">
        <div class="card-body p-5">
            <form
                action="{{ route('admin.add_subsubcategory', ['categoryId' => $categoryId, 'subcategoryId' => $subcategoryId]) }}"
                ...
                <div class="text-center">
                    <button type="submit" class="btn btn-primary btn-md px-5">Add Sub SubCategory</button>
                </div>
            </form>
        </div>
    </div>
