...
@section('content')
    ...
    <div class="card shadow-sm border-0 rounded-lg">
        <div class="card-body p-5">
            <form
                action="{{ route('admin.add_service', ['categoryId' => $categoryId, 'subcategoryId' => $subcategoryId, 'subsubcategoryId' => $subsubcategoryId]) }}"
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="time" name="time" class="form-control shadow-sm" id="time" placeholder="Enter Time">
                ...
                <div class="text-center">
                    <button type="submit" class="btn btn-primary btn-md px-5">Add Service</button>
                </div>
            </form>
        </div>
    </div>
