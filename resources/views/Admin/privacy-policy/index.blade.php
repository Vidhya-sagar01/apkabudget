...
@section('content')
    <h1 class="h3 mb-4 text-gray-800">Privacy Policy</h1>
            ...
            <div class="tab-content" id="aboutTabContent">
                <div class="tab-pane fade show active" id="user" role="tabpanel" aria-labelledby="user-tab">
                    <form action="{{ route('admin.update_privacy_policy') }}" method="POST">
                        ...
                        <button type="submit" class="btn btn-primary mt-2">Update User Privacy Policy</button>
                    </form>
                </div>
                ...
                <div class="tab-pane fade" id="partner" role="tabpanel" aria-labelledby="partner-tab">
                    <form action="{{ route('admin.update_privacy_policy') }}" method="POST">
                        ...
                        <button type="submit" class="btn btn-primary mt-2">Update Partner Privacy Policy</button>
                    </form>
                </div>
            </div>
        </div>
